    ...
    <section className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6 px-6">
        ...
        <div className="bg-green-100 p-8 rounded-lg shadow-lg">
          ...
          <div className="w-12 h-12 bg-green-200 rounded-full float-right"></div>
        </div>
        ...
        <div className="bg-blue-100 p-8 rounded-lg shadow-lg">
          ...
          <div className="w-12 h-12 bg-blue-200 rounded-full float-right"></div>
        </div>

        {/* Personal Guidance & Skill Development */}
        <div className="bg-red-100 p-8 rounded-lg shadow-lg col-span-1 sm:col-span-2">
          <h2 className="text-xl font-semibold mb-4 text-gray-800">
            Personal Guidance & Skill Development
          </h2>
          <p className="text-gray-700">
          ...
          <div className="w-12 h-12 bg-red-200 rounded-full float-right"></div>
        </div>
        ...
        <div className="bg-yellow-100 p-8 rounded-lg shadow-lg">
          ...
          <div className="w-12 h-12 bg-yellow-200 rounded-full float-right"></div>
        </div>
        ...
        <div className="bg-orange-100 p-8 rounded-lg shadow-lg">
          ...
          <div className="w-12 h-12 bg-orange-200 rounded-full float-right"></div>
        </div>
      </div>
    </section>
  );
