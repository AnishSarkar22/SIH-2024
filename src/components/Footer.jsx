...
export default function Footer() {
  ...
  return (
    <footer
      id="footer"
      className="bg-2F4454 h-auto xl:h-275 bg-no-repeat bg-center"
      style={{
    ...
    >
      ...
      <div className="container flex flex-col-reverse justify-between px-6 py-1 h-full mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="flex flex-col-reverse items-center justify-between space-y-12 lg:flex-col lg:space-y-2 lg:items-start">
          {/* LOGO */}
          <div className="lg:pt-10 pl-6 ml-5">
        ...
        <div className="flex justify-around space-x-32 mx-auto lg:pt-14">
          ...
          {/* MENU 2 */}
          <div className="flex flex-col space-y-3 text-white sm:flex-start">
            <a
              href="#"
            ...
            <div className="flex space-x-3 px-1.5">
              <div className="flex flex-col space-y-2">
                <input
                  ...
                  type="text"
                />
                <p id="response-message" className="italic text-teal-600 pl-6" />
                <p></p>
              </div>
            </div>
            <div>
              <button
                ...
                className="bg-teal-700 text-white font-bold py-3 px-6 rounded-lg hover:bg-teal-800 transition duration-300"
              >
                Go
              </button>
            </div>
