                    ...
                    >
                      ...
                      <td className="px-3 sm:px-1 py-3 sm:py-1">
                        <div className="flex flex-col sm:flex-row gap-2">
                          <button
                            className={`px-4 py-1 text-green-500 border border-green-500
                              hover:bg-green-500 hover:text-white rounded-md sm:px-4 sm:py-2 text-xs sm:text-sm font-medium ${
                              darkMode
                                ? "hover:bg-green-900"
                                : "hover:bg-green-100"
                            }`}
                          ...
                          <button
                            className={`px-2 py-1 text-red-500 border border-red-500 hover:bg-red-500
                              hover:text-white rounded-md sm:px-4 sm:py-2 text-xs sm:text-sm font-medium ${
