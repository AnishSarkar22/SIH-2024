...
const Header = () => {
  ...
  const headerContent = (
    <div className="bg-gray-200 h-auto p-4 w-full relative flex flex-col md:flex-row items-center justify-between">
      {/* Logo on the left */}
...
const SkillTag = ({ skill }) => (
  <span className="bg-gray-100 text-[#000000] text-xs font-medium mr-2 px-2 py-0.5 rounded-md h-6 md:h-8 flex justify-center items-center">
    {skill}
  </span>
);
...
const SimilarMentor = ({
  ...
  <div className="flex flex-col md:flex-row items-start md:items-center gap-4 md:gap-6 p-4 border-b border-black bg-gray-100">
    <img
      src=""
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="bg-white">
        {/* Profile Container */}
        <div className="w-full bg-gray-200 h-auto md:h-80 relative px-4 md:px-0">
            ...
            <div className="flex flex-col md:flex-row justify-between md:absolute md:bottom-0 md:transform md:translate-y-1/2 w-full max-w-7xl py-6 md:py-0">
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                ...
                <div className="w-full md:w-[400px] hidden md:block">
                  <div className="bg-gray-100 p-6 md:p-8 rounded-lg shadow-lg min-h-[350px] md:min-h-[400px] flex flex-col justify-between">
                    <div>
