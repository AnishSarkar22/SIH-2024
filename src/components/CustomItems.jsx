...
export function TwitterIcon() {
  return (
    ...
    >
      <path
        d="M23 3a10.06 10.06 0 01-2.828.775A4.94 4.94 0 0022.437 2a10.017 10.017 0 01-3.16 1.207A4.925 4.925 0 0015.572 0c-2.72 0-4.925 2.204-4.925 4.925 0 .387.043.762.124 1.122A13.975 13.975 0 011.671.963 4.917 4.917 0 001.27 3.208a4.876 4.876 0 001.085-.289 4.928 4.928 0 00-3.946 4.827 4.927 4.927 0 002.195 4.098A4.915 4.915 0 01.964 11.45v.061a4.927 4.927 0 003.95 4.825 4.934 4.934 0 01-2.225.085 4.928 4.928 0 004.604 3.42A9.88 9.88 0 010 20.8a13.932 13.932 0 007.548 2.211c9.054 0 14.016-7.499 14.016-14.016 0-.215-.005-.428-.014-.64A10.025 10.025 0 0023 3z"
        fill="#1DA1F2"
      />
    </svg>
  );
