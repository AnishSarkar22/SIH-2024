...
export default function Testimonials() {
  ...
  return (
    ...
    >
      <h2 className="text-4xl mt-20 font-bold text-center py-7 spaced-section">
        Success Stories
      </h2>
      ...
      <div className="container mx-auto spaced-section py-20">
        <div ref={swiperRef} className="swiper testimonial-slider py-16">
          <div className="swiper-wrapper">
            {/* TESTIMONIAL 1 */}
            <div className="swiper-slide">
              <div className="flex flex-col items-center text-center p-12 space-y-10 rounded-lg bg-veryLightGray">
                <img
                  src="images/avatar-anisha.png"
                  className="w-28 mt-[-2rem]"
                  alt="Anjana Guha"
                />
                <p className="font-bold text-darkBlue text-xl">Anjana Guha</p>
                <p className="text-darkGrayishBlue">
                  "My main goal was to get the guidance and learn from another
                  experienced specialist. I’m keen to grow as fast as I can in
                  my career and it’s great to have such platform like GuideMe to
                  help you."
                </p>
              </div>
            </div>
            ...
            <div className="swiper-slide">
              <div className="flex flex-col items-center text-center p-12 space-y-10 rounded-lg bg-veryLightGray">
                <img
                  ...
                  alt="Ali Bravo"
                />
                <p className="font-bold text-darkBlue text-xl">Sushmita Saha</p>
                <p className="text-darkGrayishBlue">
                  "In just a few weeks, I feel a LOT more confident navigating
                  the React world. Rohan has been an excellent mentor."
                </p>
              </div>
            </div>
            {/* TESTIMONIAL 3 */}
            <div className="swiper-slide">
              <div className="flex flex-col items-center text-center p-12 space-y-10 rounded-lg bg-veryLightGray">
                <img
                  ...
                  alt="Richard Watts"
                />
                <p className="font-bold text-darkBlue text-xl">Richard Watts</p>
                <p className="text-darkGrayishBlue">
            ...
            <div className="swiper-slide">
              <div className="flex flex-col items-center text-center p-12 space-y-10 rounded-lg bg-veryLightGray">
                <img
                  ...
                  alt="Shanai Gough"
                />
                <p className="font-bold text-darkBlue text-xl">Shanai Gough</p>
                <p className="text-darkGrayishBlue">
                  "Between now and 6 months ago, I feel like I improved as an
                  engineer. Looking back, I took a huge step, beyond my
                  expectations"
                </p>
              </div>
            </div>
